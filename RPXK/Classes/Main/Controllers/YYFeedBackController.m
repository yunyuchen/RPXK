...
-(void) serviceButtonButtonClick:(UIButton *)sender
{
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:[NSString stringWithFormat:@"tel://%@",@"4007785701"]]];
}
/**
 *  取消输入
 */
...
//    [_submitBtn setBackgroundColor:[UIColor colorWithHexString:@"#315FC6"]];
//
//    //圆角
//    //设置圆角
