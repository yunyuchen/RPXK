...
#pragma mark - NavigationBar
    ...
    QMUICMI.navBarBackgroundImage =  [UIImage navigationBarBackgroundImageWithThemeColor:[UIColor colorWithHexString:@"#315FC6"]];                                        // NavBarBackgroundImage : UINavigationBar 的背景图
